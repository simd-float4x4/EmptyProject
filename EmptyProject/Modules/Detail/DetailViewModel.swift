...
//  EmptyProject
//
//  Detail Module ViewModel
//

import Foundation
import Combine

final class DetailViewModel: ViewModelProtocol, ObservableObject {
    ...
    private func fetchDetail() {
        ...
        MVVMアーキテクチャでは、各画面がモジュールとして独立しており、以下のコンポーネントで構成されています：
        
        • View: UI表示を担当（SwiftUI View + UIHostingController）
        • ViewModel: ViewとModelの仲介を担当、ビジネスロジックを処理
        • Model: データモデルを定義
        • Router: 画面遷移を担当
